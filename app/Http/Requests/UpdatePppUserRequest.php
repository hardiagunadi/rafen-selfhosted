...
class UpdatePppUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'customer_id' => ['nullable', 'string', 'max:120', Rule::unique('ppp_users', 'customer_id')->ignore($pppUser?->id)],
            'customer_name' => ['sometimes', 'required', 'string', 'max:150'],
            'nik' => ['nullable', 'string', 'max:191'],
            'nomor_hp' => ['sometimes', 'required', 'string', 'max:30', Rule::unique('ppp_users', 'nomor_hp')->ignore($pppUser?->id)],
            ...
            'username' => ['sometimes', 'required', 'string', 'max:120', Rule::unique('ppp_users', 'username')->ignore($pppUser?->id)],
