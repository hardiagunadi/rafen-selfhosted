...
return [
    ...
    'log_path' => env('GENIEACS_LOG_PATH', storage_path('logs/genieacs.log')),
    'services' => [
        'cwmp' => [
            'label' => 'GenieACS CWMP',
            'status_command' => env('GENIEACS_CWMP_STATUS_COMMAND', 'systemctl is-active genieacs-cwmp'),
            'restart_command' => env('GENIEACS_CWMP_RESTART_COMMAND', 'systemctl restart genieacs-cwmp'),
        ],
        'nbi' => [
            'label' => 'GenieACS NBI',
            'status_command' => env('GENIEACS_NBI_STATUS_COMMAND', 'systemctl is-active genieacs-nbi'),
            'restart_command' => env('GENIEACS_NBI_RESTART_COMMAND', 'systemctl restart genieacs-nbi'),
        ],
        'fs' => [
            'label' => 'GenieACS FS',
            'status_command' => env('GENIEACS_FS_STATUS_COMMAND', 'systemctl is-active genieacs-fs'),
            'restart_command' => env('GENIEACS_FS_RESTART_COMMAND', 'systemctl restart genieacs-fs'),
        ],
    ],
